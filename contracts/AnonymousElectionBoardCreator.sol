...
import "./AnonymousElectionBoard.sol";

contract AnonymousElectionBoardCreator {
    ...
    function createElection(string memory _electionName, string[] memory _candidates, address[] memory _voters, bytes memory _p, bytes memory _g) public returns(address) {
        ...
        // create election
        AnonymousElectionBoard election = new AnonymousElectionBoard(_candidates, _voters, _p, _g, msg.sender, _electionName);
